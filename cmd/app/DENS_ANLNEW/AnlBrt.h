/** \mainpage ФАС-3
 *
 * Формирователь аналоговых сигналов ИПК-3 новый
 *
 ...
 * @brief Интерфейс формирователя аналоговых сигналов (ФАС) нового
 * @file AnlBrt.h
 * @details
 * Проект: ИПК-3 
...
//! Смещение в EEPROM, где хранится таблица коррекции
#define EEPROM_LOC 128
...
typedef struct _AnlCorrection
{
  float corr[ANLG_SGNLS_COUNT];
} ANL_CORRECTION, *PANL_CORRECTION;
...
extern xdata volatile ANL_CORRECTION corr_data;
